...
cocos2dx_creator_v2_download_files = [
    'CocosCreator_v2.1.0_win',
    'CocosCreator_v2.1.0_mac',
    'CocosCreator_v2.0.7_win',
    'CocosCreator_v2.0.7_mac',
    'CocosCreator_v2.0.6_win',
    'CocosCreator_v2.0.6_mac',
    'CocosCreator_v2.0.5_win',
    'CocosCreator_v2.0.5_mac',
    'CocosCreator_v2.0.4_win',
    'CocosCreator_v2.0.4_mac',
    'CocosCreator_v2.0.2_win',
    'CocosCreator_v2.0.2_mac',
    'CocosCreator_v2.0.1_win',
    'CocosCreator_v2.0.1_mac',
    'CocosCreator_v2.0.0_win',
    'CocosCreator_v2.0.0_mac',
]

cocos2dx_creator_v1_download_files = [
    'CocosCreator_v1.10.2_win',
    'CocosCreator_v1.10.2_mac',
    'CocosCreator_v1.10.1_win',
    'CocosCreator_v1.10.1_mac',
    'CocosCreator_v1.10.0_win',
    'CocosCreator_v1.10.0_mac',
    'CocosCreator_1.9.3_win',
    'CocosCreator_v1.9.3_mac',
...
def parse_download_files():
	soup = BeautifulSoup(open("cocos2dx-download.html"), "html.parser")
...
def generate_auto_files():
	...
	_generate_download_md('auto/cocos2d-x-engine.md', cocos2dx_engine, cocos2dx_download_files,
	                      '### Cocos 引擎下载\n\n*从 v3.7 开始，Cocos2d-js 合并入 Cocos2d-x。*\n')

	cocos2dx_support_tools = OrderedDict()
	cocos2dx_support_tools['Cocos Creator v1 下载'] = cocos2dx_creator_v1_download_files
	cocos2dx_support_tools['Cocos Creator v2 下载'] = cocos2dx_creator_v2_download_files
	...
	_generate_download_md('auto/cocos2d-x-support-tools.md',
	                      cocos2dx_support_tools, cocos2dx_download_files, '### Cocos 配套工具下载\n')
